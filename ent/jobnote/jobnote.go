...
const (
	// Label holds the string label denoting the jobnote type in the database.
	Label = "job_note"
	...
	EdgePartner = "partner"
	// Table holds the table name of the jobnote in the database.
	Table = "job_notes"
...
// Columns holds all SQL columns for jobnote fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "job_notes"
...
// OrderOption defines the ordering options for the JobNote queries.
