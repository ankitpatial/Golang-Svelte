...
func (uaq *UserAuthQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (uaq *UserAuthQuery) FirstIDX(ctx context.Context) string {
...
func (uaq *UserAuthQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (uaq *UserAuthQuery) OnlyIDX(ctx context.Context) string {
...
func (uaq *UserAuthQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (uaq *UserAuthQuery) IDsX(ctx context.Context) []string {
	ids, err := uaq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(userauth.FieldProviderID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserAuth.Query().
//		Select(userauth.FieldProviderID).
//		Scan(ctx, &v)
...
func (uaq *UserAuthQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserAuth, init func(*UserAuth), assign func(*UserAuth, *User)) error {
	...
	nodeids := make(map[string][]*UserAuth)
	for i := range nodes {
...
func (uaq *UserAuthQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userauth.Table, userauth.Columns, sqlgraph.NewFieldSpec(userauth.FieldID, field.TypeString))
	_spec.From = uaq.sql
...
func (uaq *UserAuthQuery) Modify(modifiers ...func(s *sql.Selector)) *UserAuthSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (uas *UserAuthSelect) Modify(modifiers ...func(s *sql.Selector)) *UserAuthSelect {
