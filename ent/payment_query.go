...
func (pq *PaymentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Payment, error) {
	...
	if query := pq.withJob; query != nil {
		if err := pq.loadJob(ctx, query, nodes, nil,
			func(n *Payment, e *Job) { n.Edges.Job = e }); err != nil {
			return nil, err
		}
	}
...
func (pq *PaymentQuery) loadJob(ctx context.Context, query *JobQuery, nodes []*Payment, init func(*Payment), assign func(*Payment, *Job)) error {
