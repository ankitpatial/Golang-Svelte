...
// HasSockets applies the HasEdge predicate on the "sockets" edge.
func HasSockets() predicate.UserSession {
...
// HasSocketsWith applies the HasEdge predicate on the "sockets" edge with a given conditions (other predicates).
func HasSocketsWith(preds ...predicate.UserSessionSocket) predicate.UserSession {
	return predicate.UserSession(func(s *sql.Selector) {
		step := newSocketsStep()
...
func HasPartner() predicate.UserSession {
	return predicate.UserSession(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasPartnerWith(preds ...predicate.Partner) predicate.UserSession {
	return predicate.UserSession(func(s *sql.Selector) {
		step := newPartnerStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasPartnerContact applies the HasEdge predicate on the "partner_contact" edge.
func HasPartnerContact() predicate.UserSession {
	return predicate.UserSession(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPartnerContactWith applies the HasEdge predicate on the "partner_contact" edge with a given conditions (other predicates).
func HasPartnerContactWith(preds ...predicate.PartnerContact) predicate.UserSession {
	return predicate.UserSession(func(s *sql.Selector) {
		step := newPartnerContactStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
