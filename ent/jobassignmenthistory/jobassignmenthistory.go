...
const (
	// Label holds the string label denoting the jobassignmenthistory type in the database.
	Label = "job_assignment_history"
	...
	EdgePartner = "partner"
	// Table holds the table name of the jobassignmenthistory in the database.
	Table = "job_assignment_history"
	// JobTable is the table that holds the job relation/edge.
	JobTable = "job_assignment_history"
	...
	PartnerTable = "job_assignment_history"
...
// Columns holds all SQL columns for jobassignmenthistory fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldStatus,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "job_assignment_history"
...
const DefaultStatus enum.JobAssignmentStatus = "Assigned"

// StatusValidator is a validator for the "status" field enum values. It is called by the builders before save.
func StatusValidator(s enum.JobAssignmentStatus) error {
	switch s.String() {
	case "Assigned", "Accepted", "Rejected", "Expired":
		return nil
	default:
		return fmt.Errorf("jobassignmenthistory: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the JobAssignmentHistory queries.
...
var (
	// enum.JobAssignmentStatus must implement graphql.Marshaler.
	_ graphql.Marshaler = (*enum.JobAssignmentStatus)(nil)
	// enum.JobAssignmentStatus must implement graphql.Unmarshaler.
	_ graphql.Unmarshaler = (*enum.JobAssignmentStatus)(nil)
)
