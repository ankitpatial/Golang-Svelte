...
const (
	// Label holds the string label denoting the partneractivity type in the database.
	Label = "partner_activity"
	...
	// Table holds the table name of the partneractivity in the database.
	Table = "partner_activities"
	// PartnerTable is the table that holds the partner relation/edge.
	PartnerTable = "partner_activities"
	...
	CreatorTable = "partner_activities"
	...
	CreatorAPITable = "partner_activities"
...
// Columns holds all SQL columns for partneractivity fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldDescription,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "partner_activities"
...
// OrderOption defines the ordering options for the PartnerActivity queries.
